[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.6226159.svg)](https://doi.org/10.5281/zenodo.6226159)
# amp-expand
...
[amp-expand/ric_metadata](https://github.com/timofruehwirth/amp-expand/tree/main/ric_metadata/data/py) holds a Python script (in development) which reads a CSV file containing metadata of the AMP documents and writes them in [RDF XML format](https://github.com/auden-musulin-papers/data/ric_metadata/ric_metadata.csv).
